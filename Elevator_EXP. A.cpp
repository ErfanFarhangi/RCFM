...
int n = 10; // all elevators + requests + destinations (dimension of cost matrix) 
int m = 2; // number of elevators 
int l[2] = {2,3}; // elevator locations 
																							

int Elevator_Requests[1] = {4}; 
int Elevator_Requests_Sources[1] = {7}; 

int U_Max = 1;  
bool flag_repetition = false; 
bool check_l[2] = {0,0}; 
int r[8] = { 1,5,4,6,7,8,9,10 }; // requests+destinations 
int r2[2] = { 1,5 }; // just requests 
int d[5] = { 6,7,8,9,10 }; // destinations 

int AllRequests[3] = { 1,4,5 }; /* including elevator requests */ 
int AllRequests_Sources[3] = { 4, 7, 8 }; /* including elevator requests */ 
bool AllRequests_Types[3] = { 1,0,1}; /* 1 indicates only request and 0 indicates elevator requests  */  

int PoissonArrival[3] = {1,2,3 };  
bool flag_round = false;


int p = 3; // number of stops 
...
int C[10][10] = {
	{ maxint, 0, 0, 4, 0, 5, maxint, maxint, maxint },
	{ 1, maxint, maxint, 3, maxint, maxint, maxint, maxint, maxint },
	{ 3, maxint, maxint, 1, maxint, maxint, 5, 1, maxint },
	{ 4, 0, 0, maxint, maxint, maxint, maxint, maxint, 2 },
	{ 0, 0, 0, 4, maxint, 5, maxint, maxint, maxint },
	{ 5, 0, 0, 1, 5, maxint, maxint, maxint, maxint },
	{ 2, 0, 0, 6, maxint, maxint, maxint, 6, maxint },
	{ 4, 0, 0, 0, maxint, maxint, 6, maxint, maxint },
	{ 6, 0, 0, 2, maxint, maxint, maxint, maxint, maxint },
};
int num_e[2] = { 1,1 }; // elevator numbers (fi) 


int Size_l = 2; 
int Size_r = 8; 
int Size_r2 = 2; 
int Size_Elevator_Requests = 1;
int Size_d = 5; 


bool d_visited[5] = {0,0,0,0,0};
int d_waitingtime[5] = {0,0,0,0,0};
int d_travelingtime[5] = {0,0,0,0,0 };
int d_stops[5] = {0,0,0,0,0};
int TotalCost = 0;
...
void InputTransformation()
{
	...
	int Source_Floors[9] = { 4,5,7,8,4,4,7,7,8 };
	int Floor_types[9] = { 2,1,1,2,4,4,4,4,4 }; // 1 for elevators, 2 for requests, 3 for elevator requests, 4 for destinations
	int Destination_floors[9] = { -1,-1,-1,-1,4,9,2,8,10 };
